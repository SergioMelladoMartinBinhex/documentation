...
ePos printers are designed to work seamlessly with Point of Sale systems. When connected to the POS
system, the two devices automatically share information. This integration enables the direct
...
IP address in HTTPS leads to a warning page.
...
Generating, exporting, and importing a **self-signed certificate** is mandatory for a long-term
solution.
   ...
   .. tab:: Windows 10 & Linux OS
      ...
      .. tabs::
         ...
         .. tab:: Generate a self-signed certificate
            ...
            Period` field, click :guilabel:`Create`, and :guilabel:`Reset` or turn the printer off
            and back on.
         ...
         .. tab:: Export a self-signed certificate
            ...
            #. click the **lock-shaped** icon next to the search bar;
         ...
         .. tab:: Import a self-signed certificate
            ...
            .. tabs::
               ...
               .. tab:: Windows 10
                  ...
                  Windows 10's operating system manages certificates, which means that self-signed
                  certificates must be imported from the certification file rather than the browser.
                  To do so,
